...
const opcode_t i_NOP   = 24; // nop
const opcode_t i_ORR   = 25; // bitwise OR
const opcode_t i_POP   = 26; // pop registers
const opcode_t i_PUSH  = 27; // push registers
const opcode_t i_ROR   = 28; // rotate right
const opcode_t i_SBC   = 29; // subtract with carry
const opcode_t i_STMIA = 30; // store multiple
const opcode_t i_STR   = 31; // store word
const opcode_t i_STRB  = 32; // store byte
const opcode_t i_STRH  = 33; // store halfword
const opcode_t i_SWI   = 34; // software interrupt
